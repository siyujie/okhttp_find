 ...
 * has been configured to {@link com.singleman.gson.GsonBuilder#serializeNulls()}, these nulls will be
...
public abstract class TypeAdapter<T> {
   ...
   * Unlike Gson's similar {@link com.singleman.gson.Gson#toJson(com.singleman.gson.JsonElement, Appendable) toJson}
   ...
   * com.singleman.gson.Gson#toJson(Object) toJson} method, this write is strict. Create a {@link
   * JsonWriter#setLenient(boolean) lenient} {@code JsonWriter} and call
   * {@link #write(JsonWriter, Object)} for lenient
   * writing.
   *
   ...
   *
   * @param value the Java object to convert. May be null.
   * @return the converted JSON tree. May be {@link com.singleman.gson.JsonNull}.
   * @since 2.2
   */
  public final com.singleman.gson.JsonElement toJsonTree(T value) {
    try {
   ...
   * similar {@link com.singleman.gson.Gson#fromJson(Reader, Class) fromJson} method, this
